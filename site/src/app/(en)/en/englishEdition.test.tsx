...
import EnglishPage, { metadata as enMetadata } from "@/app/(en)/en/page";
import { metadata as heMetadata } from "@/app/(he)/page";
...
describe("edition cover isolation", () => {
  ...
  it("keeps the Hebrew cover on the Hebrew surfaces", () => {
    ...
    const bookSrc = readFileSync(resolve(process.cwd(), "src/app/(he)/book/page.tsx"), "utf8");
