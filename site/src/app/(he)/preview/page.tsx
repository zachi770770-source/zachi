...
export default async function PreviewPage({
  ...
  return (
    <>
      ...
      {/* אין כאן בקרות צפות. עמוד-הטעימה הוא חוויית קריאה, וכל שכבה שמרחפת
          מעליה מתחרה בה: ה-PreviewStickyCta הוסר, וגם בועת-המצפן (שהוסרה
          ברמת ה-layout). מה שנשאר הוא הטקסט, ובסופו הרכישה. */}
    </>
  );
}
