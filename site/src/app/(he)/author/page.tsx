...
export const metadata = pageMetadata({
  ...
  // עמוד-הישות של המחבר. התיאור הקודם (62 תווים) היה קצר מדי מכדי לומר מי
  // האדם הזה ומה הקשר בינו לבין הספר — וזה בדיוק מה שעמוד ישות צריך לומר.
  // הנוסח כאן מחבר את שלושת הצמתים (צחי חן ↔ הספר ↔ האתר) בלי להמציא תארים,
  // הסמכות או מומחיות מקצועית.
  description: `צחי חן הוא מחבר „${siteConfig.bookTitle}”, ספר מעשי על דייטים, בחירת בן או בת זוג ובניית זוגיות. כאן הוא מספר למה כתב אותו, למי הוא נכתב ומה הגישה שמאחוריו.`,
  path: "/author",
  ogType: "article",
});
