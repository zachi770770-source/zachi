 ...
 *   3. AuthorNote      — מי כתב את זה, עם פנים. אמון לפני כל בקשה.
 *   4. WhyTheBook      — מה הספר נותן: אתר-מול-ספר ומבנה הספר, כבלוק אחד.
...
export default function HomePage() {
  return (
    <>
      ...
      <Hero />
      <RecognitionBeat />
      {/* אמון לפני בקשה: מי כתב, ולמה. */}
      <AuthorNote />
      {/* הטיעון: למה ספר, ומה יש בו. בלוק אחד ולא שני חצאים סביב הכלים. */}
      <WhyTheBook />
