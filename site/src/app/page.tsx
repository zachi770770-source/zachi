 ...
 *      מצבים; התוצאה קצרה ומובילה *ישירות לתוך הספר*: הפעולה הראשית היא טעימה
 *      מותאמת (`/preview?tool=&station=` — קטע אמיתי מהתוכן המאושר של הכלי
 *      הקרוב-ביותר לאותו מצב), „שאל את הספר” משני (עם הקשר-המצב, כדי לא לשאול
 *      שוב „איפה אתם?”), וקישור-התחנה שלישי. היעד: שתי פעולות מהבית עד קריאה.
