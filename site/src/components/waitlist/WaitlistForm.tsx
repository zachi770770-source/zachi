  ...
  if (status === "success") {
    return (
      <div
        role="status"
        aria-live="polite"
        className="flex items-start gap-3 rounded-lg border border-brand/30 bg-brand-muted px-4 py-4 text-[15px] text-foreground"
      >
        <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-brand-hover" aria-hidden="true" />
