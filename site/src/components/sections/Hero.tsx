      ...
      <Container className="sig-hero__container">
        <div className="sig-hero__scene">
          ...
          <div className="sig-hero__copy">
            ...
            {/* שורת-משנה אחת, בכל רוחב.
                קודם עמדו כאן שתי גרסאות שפתחו שתיהן ב„מציאת אדם היא רק ההתחלה” —
                כלומר פרפרזה של ה-H1 שנמצא שני סנטימטרים מעליהן. שורת-משנה שחוזרת
                על הכותרת אינה מקדמת דבר, והיא גם מיסגרה את הספר סביב *המציאה*:
                מבקר שנשוי חמש-עשרה שנה קרא כאן שהעניין מתחיל במצוא מישהו.
                הניסוח החדש ממשיך את ההבטחה במקום לשחזר אותה — דפוסים, בחירות
                וקשרים — ולכן הוא נכון גם למי שעדיין מחפש וגם למי שכבר שנים יחד.
                אלמנט אחד בלי מודיפייר מוצג בכל רוחב, ולכן ה-CSS לא נגע. */}
            <p className="sig-hero__sub">
              הספר עוזר לזהות את הדפוסים שמנהלים את הבחירות והקשרים שלכם — וללמוד מה
              לעשות אחרת ברגעים שבהם הם חוזרים.
            </p>
