...
export type AnalyticsEventName =
  ...
  | "love_viewed"
  // „דייטים” (/dating) — עמוד-הסמכות של אשכול הדייטים וההיכרות, התאום המבני
  // של /love. נמדד מהיום הראשון כדי שנדע אם הוא מביא כניסות אורגניות.
  | "dating_viewed"
  // „מדריכים” (/guide) — מדד-הגילוי של אינדקס המדריכים.
  | "guide_index_viewed"
  // קליק מתוכן רוחבי (עמוד-אב / אינדקס / ציר-המסע) אל התוכן שמתחתיו:
  //   { from: "love" | "dating" | "guide" | "journey", to: "<נתיב פנימי>" }
  // זהו המדד שחסר כדי לדעת אם עמודי-האב באמת מזרימים קוראים פנימה, או רק
  // אוספים כניסות אורגניות ומאבדים אותן. שם אחד עם פרמטרים, ולא שבעה שמות
  // כמעט-זהים לכל צמד עמודים.
  | "pillar_link_clicked"
  ...
  // ‏(הגשת הוכחת-רכישה → pending → בדיקה ידנית → approved; `reader_bonus_approved`
  //  ו-`reader_kit_accessed` נורים בכניסה של קורא מאושר לערכה.)
  | "reader_bonus_view"
