...
export const guideIndexMeta = {
  ...
  /**
   * פסקת-התמצאות קצרה מעל הספרייה.
   *
   * העמוד היה רשימה כמעט נטו: מי שידע מה הוא מחפש הסתדר, ומי שלא, נתקל
   * בעשרים ושלוש כותרות. הפסקה הזו אומרת במשפט אחד *אילו נושאים* יש כאן,
   * בשפה שבה אנשים באמת שואלים — ולכן היא גם מה שמסביר לזחלן על מה האשכול.
   * שני קישורים בלבד, אל שני עמודי-האב, כדי שזו תישאר פסקה ולא עוד תפריט.
   */
  orientation: {
    body:
      "רוב מי שמגיע לכאן מחפש אחד מכמה דברים: איך להיכנס לדייט ראשון בלי להפוך אותו למבחן, איך לבחור בן או בת זוג ולזהות התאמה אמיתית, למה סדרה של דייטים נעצרת ואיך בכל זאת עוברים מדייטים לקשר, ומה שומר על זוגיות בריאה כשכבר יש קשר — תקשורת, ריבים שחוזרים, וגם פרידה והתחלה מחדש. כל אלה יושבים על שני עמודי-אב:",
    links: [
      { href: "/dating", label: "דייטים: מה באמת קורה בשלב ההיכרות" },
      { href: "/love", label: "אהבה: מהי, ואיך היא נבנית לאורך זמן" },
    ],
  },
  byline: {
    prefix: "מאת",
