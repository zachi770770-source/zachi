# מדייטים לאהבה — האתר הרשמי של הספר

> דייטינג הוא חיפוש. אהבה היא בנייה.

האתר הרשמי של הספר „מדייטים לאהבה” מאת צחי חן. הספר **זמין לרכישה**
במהדורת Kindle באמזון (ASIN `B0GJ3SL9H2`); האתר הוא נכס-התוכן והרכישה שלו. בנוי ב-Next.js 16
